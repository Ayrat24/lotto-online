...
static bool TryMapDockerStyleDotEnvKey(string key, out string mappedKey)
{
    mappedKey = key switch
    {
        ...
        "TELEGRAMTON_HOT_WALLET_VERSION" => "Payments:TelegramTon:HotWalletVersion",
        ...
        "TELEGRAMTON_HOT_WALLET_NETWORK_GLOBAL_ID" => "Payments:TelegramTon:HotWalletNetworkGlobalId",
